-- Restore NOT NULL constraint on expires_at by recreating the table.
UPDATE proxy_tokens SET expires_at = '9999-12-31T23:59:59Z' WHERE expires_at IS NULL;

CREATE TABLE proxy_tokens_old (
    id TEXT PRIMARY KEY,
...
INSERT INTO proxy_tokens_old (id, token_hash, token_prefix, token_type, user_id, github_token_id, installation_id, repositories, scopes, session_id, expires_at, revoked_at, app_id, created_at)
...
ALTER TABLE proxy_tokens_old RENAME TO proxy_tokens;
