...
-- to match the pattern used in migration 007.
...
INSERT INTO cached_repositories_backup SELECT id, owner, name, enabled, timeout_seconds, created_at, updated_at FROM cached_repositories;
